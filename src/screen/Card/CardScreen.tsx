        ...
        <ScrollView>
          ...
          <View style={styles.sectionContainer}>
            ...
            <View
              ...
              {address == null ? (
                <TouchableOpacity
                  ...
                  <Text style={Styles.title_Regular}>create an address</Text>
                </TouchableOpacity>
              ) : (
                <>
                  ...
                  <View
                    style={[Styles.justifyCenter, styles.dropdownIndicator]}>
                    <PlusIcon name={'check'} color={Color.white} size={20} />
                  </View>
                </>
              )}
            </View>
            ...
            <View style={styles.rowBetween}>
              ...
              <Text style={[Styles.title_Bold, styles.blackText]}>Free</Text>
            </View>
